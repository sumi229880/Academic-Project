...
public class AjaxController {
	...
	protected String doSubmitActionUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
	...
	protected String doSubmitActionMail(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			String username = request.getParameter("user");
			System.out.println("username" + username);
			User usersearch;
	...
	protected String doSubmitActionHusky(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			String username = request.getParameter("user");
	...
	protected String doSubmitActionLogin(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			String username = request.getParameter("user");
